...
| Main backend | `food-delivery-backend` | `afe2e4348143a915d1ffd7168309a6eae44898b1` (`codex/vert-001-catalog`), base `766394291771ed5f6564d4f0cd35a7269b01d949` | Audited + VERT-001 catalog + VERT-002 cart implemented; review pending | README, Go module, router, config, migrations, service tree, baseline, catalog, cart checks |
