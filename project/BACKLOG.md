...
| PERSONA-001 | 4 | P1 | L | Frontend/Backend | all app repos | In progress — owner API ready | Restaurant owner, driver, and operations journeys work against integrated services; owner order list/status API is ready, while role-specific UIs remain |
