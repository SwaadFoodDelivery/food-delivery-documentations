...
| PERSONA-001 | 4 | P1 | L | Frontend/Backend | all app repos | In progress — driver workflow done | Restaurant owner and driver demo journeys work against integrated mock APIs; operations visibility and browser persona evidence remain |
