...
| FRONT-001 | 3 | P1 | L | Frontend | frontend, backend | In progress — tracking slice done | Customer discovery→menu→cart→checkout→tracking UI; tracking is implemented, while discovery, cart, checkout, and browser evidence remain |
