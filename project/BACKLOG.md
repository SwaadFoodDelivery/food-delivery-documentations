...
| PERSONA-001 | 4 | P1 | L | Frontend/Backend | all app repos | In progress — owner queue done | Restaurant owner queue now discovers the owner restaurant and drives valid order transitions; driver availability/assignment/pickup and operations journeys remain |
